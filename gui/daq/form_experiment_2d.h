...
namespace Ui {
class FormExperiment2D;
}

class FormExperiment2D : public QWidget
{
  Q_OBJECT

public:
  explicit FormExperiment2D(Qpx::ExperimentProject&,
...
private slots:
  ...
  void on_comboDomain2_currentIndexChanged(int index);
