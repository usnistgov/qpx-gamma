...
FormMultiGates::FormMultiGates(QSettings &settings, XMLableDB<Gamma::Detector>& dets, Gamma::Fitter& fit1, Gamma::Fitter& fit2, QWidget *parent) :
  QWidget(parent),
...
void FormMultiGates::newSpectrum() {
...
void FormMultiGates::update_peaks() {
  plot_calib();
}

void FormMultiGates::plot_calib() {
  ui->plotCalib->clearGraphs();
...
void FormMultiGates::selection_changed_in_plot() {
...
void FormMultiGates::on_pushSaveCalib_clicked()
{
  emit update_detector();
}

void FormMultiGates::on_pushRemovePeak_clicked()
{
...
void FormMultiGates::on_pushCalibGain_clicked()
{
  int total = fit_data1_.peaks_.size();
  if (total != fit_data2_.peaks_.size())
  {
...
void FormMultiGates::on_pushCull_clicked()
{
  //while (cull_mismatch()) {}
...
void FormMultiGates::on_pushSymmetrize_clicked()
{
